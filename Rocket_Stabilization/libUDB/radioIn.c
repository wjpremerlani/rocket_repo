...
#define _IC_HANDLER_ECHO(x, y, z, w) \
void __attribute__((__interrupt__,__no_auto_psv__)) _IC##x##Interrupt(void) \
{ \
	static uint16_t rise = 0; \
	uint16_t time = 0; \
...
#define IC_HANDLER_ECHO( x, y, z, w) _IC_HANDLER_ECHO( x, y, z, w)

//IC_HANDLER_ECHO(1, REGTOK1, IC_PIN1, _LATD0);
//IC_HANDLER_ECHO(2, REGTOK1, IC_PIN2, _LATD1);
//IC_HANDLER_ECHO(3, REGTOK1, IC_PIN3, _LATD2);
//IC_HANDLER_ECHO(4, REGTOK1, IC_PIN4, _LATD3);
